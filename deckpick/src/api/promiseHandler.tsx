function resolvePromise(promise: any, promiseState: any)
{
    ...
    function saveDataACB(result: any)
    {
...
function resolvePromises(promises: any, promiseState: any)
{
    if(promises === null)
        return;
